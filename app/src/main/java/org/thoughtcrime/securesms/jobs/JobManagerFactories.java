...
import org.thoughtcrime.securesms.ryan.jobmanager.impl.CellServiceConstraintObserver;
...
import org.thoughtcrime.securesms.ryan.jobmanager.impl.ChargingAndBatteryIsNotLowConstraintObserver;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.ChargingConstraint;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.DataRestoreConstraint;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.DataRestoreConstraintObserver;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.DecryptionsDrainedConstraint;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.DecryptionsDrainedConstraintObserver;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.NetworkConstraint;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.NetworkConstraintObserver;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.NetworkOrCellServiceConstraint;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.NotInCallConstraint;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.NotInCallConstraintObserver;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.RestoreAttachmentConstraint;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.RestoreAttachmentConstraintObserver;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.SqlCipherMigrationConstraint;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.SqlCipherMigrationConstraintObserver;
import org.thoughtcrime.securesms.ryan.jobmanager.impl.WifiConstraint;
import org.thoughtcrime.securesms.ryan.jobmanager.migrations.DeprecatedJobMigration;
import org.thoughtcrime.securesms.ryan.jobmanager.migrations.DonationReceiptRedemptionJobMigration;
import org.thoughtcrime.securesms.ryan.jobmanager.migrations.GroupCallPeekJobDataMigration;
import org.thoughtcrime.securesms.ryan.jobmanager.migrations.PushDecryptMessageJobEnvelopeMigration;
import org.thoughtcrime.securesms.ryan.jobmanager.migrations.PushProcessMessageJobMigration;
import org.thoughtcrime.securesms.ryan.jobmanager.migrations.RetrieveProfileJobMigration;
import org.thoughtcrime.securesms.ryan.jobmanager.migrations.SendReadReceiptsJobMigration;
import org.thoughtcrime.securesms.ryan.jobmanager.migrations.SenderKeyDistributionSendJobRecipientMigration;
import org.thoughtcrime.securesms.ryan.migrations.AccountConsistencyMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.AccountRecordMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.AepMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.ApplyUnknownFieldsToSelfMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.AttachmentCleanupMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.AttachmentHashBackfillMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.AttributesMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.AvatarColorStorageServiceMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.AvatarIdRemovalMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.AvatarMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.BackfillDigestsForDuplicatesMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.BackfillDigestsMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.BackupJitterMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.BackupNotificationMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.BadE164MigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.BlobStorageLocationMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.CachedAttachmentsMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.ClearGlideCacheMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.ContactLinkRebuildMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.CopyUsernameToSignalStoreMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.DatabaseMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.DeleteDeprecatedLogsMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.DirectoryRefreshMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.DuplicateE164MigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.E164FormattingMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.EmojiDownloadMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.EmojiSearchIndexCheckMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.FixChangeNumberErrorMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.GooglePlayBillingPurchaseTokenMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.IdentityTableCleanupMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.LegacyMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.MigrationCompleteJob;
import org.thoughtcrime.securesms.ryan.migrations.OptimizeMessageSearchIndexMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.PassingMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.PinOptOutMigration;
import org.thoughtcrime.securesms.ryan.migrations.PinReminderMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.PniAccountInitializationMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.PniMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.PnpLaunchMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.PreKeysSyncMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.ProfileMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.ProfileSharingUpdateMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.RebuildMessageSearchIndexMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.RecheckPaymentsMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.RecipientSearchMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.SelfRegisteredStateMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.StickerAdditionMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.StickerDayByDayMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.StickerLaunchMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.StickerMyDailyLifeMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.StorageCapabilityMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.StorageFixLocalUnknownMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.StorageServiceMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.StorageServiceSystemNameMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.StoryViewedReceiptsStateMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.SubscriberIdMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.Svr2MirrorMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.SyncCallLinksMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.SyncChatFoldersMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.SyncDistributionListsMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.SyncKeysMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.TrimByLengthSettingsMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.UpdateSmsJobsMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.UserNotificationMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.UuidMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.WallpaperCleanupMigrationJob;
import org.thoughtcrime.securesms.ryan.migrations.WallpaperStorageMigrationJob;
