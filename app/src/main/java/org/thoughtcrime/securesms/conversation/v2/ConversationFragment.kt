...
<<<<<<< HEAD
import org.thoughtcrime.securesms.ryan.BlockUnblockDialog
import org.thoughtcrime.securesms.ryan.GroupMembersDialog
import org.thoughtcrime.securesms.ryan.LoggingFragment
import org.thoughtcrime.securesms.ryan.MainActivity
import org.thoughtcrime.securesms.ryan.MuteDialog
...
import org.thoughtcrime.securesms.ryan.badges.gifts.OpenableGift
import org.thoughtcrime.securesms.ryan.badges.gifts.OpenableGiftItemDecoration
import org.thoughtcrime.securesms.ryan.badges.gifts.viewgift.received.ViewReceivedGiftBottomSheet
import org.thoughtcrime.securesms.ryan.badges.gifts.viewgift.sent.ViewSentGiftBottomSheet
import org.thoughtcrime.securesms.ryan.billing.upgrade.UpgradeToStartMediaBackupSheet
...
import org.thoughtcrime.securesms.ryan.components.ConversationSearchBottomBar
import org.thoughtcrime.securesms.ryan.components.DeleteSyncEducationDialog
import org.thoughtcrime.securesms.ryan.components.HidingLinearLayout
import org.thoughtcrime.securesms.ryan.components.InputAwareConstraintLayout
import org.thoughtcrime.securesms.ryan.components.InputPanel
...
import org.thoughtcrime.securesms.ryan.components.SendButton
...
import org.thoughtcrime.securesms.ryan.components.settings.app.subscription.donate.CheckoutFlowActivity
import org.thoughtcrime.securesms.ryan.components.settings.app.subscription.donate.DonateToSignalFragment
...
import org.thoughtcrime.securesms.ryan.contacts.paged.ContactSearchKey.RecipientSearchKey
...
import org.thoughtcrime.securesms.ryan.contactshare.SharedContactDetailsActivity
import org.thoughtcrime.securesms.ryan.conversation.AttachmentKeyboardButton
import org.thoughtcrime.securesms.ryan.conversation.BadDecryptLearnMoreDialog
import org.thoughtcrime.securesms.ryan.conversation.ConversationAdapter
import org.thoughtcrime.securesms.ryan.conversation.ConversationBottomSheetCallback
import org.thoughtcrime.securesms.ryan.conversation.ConversationData
import org.thoughtcrime.securesms.ryan.conversation.ConversationHeaderView
import org.thoughtcrime.securesms.ryan.conversation.ConversationIntents
import org.thoughtcrime.securesms.ryan.conversation.ConversationIntents.ConversationScreenType
import org.thoughtcrime.securesms.ryan.conversation.ConversationItem
import org.thoughtcrime.securesms.ryan.conversation.ConversationItemSelection
import org.thoughtcrime.securesms.ryan.conversation.ConversationItemSwipeCallback
import org.thoughtcrime.securesms.ryan.conversation.ConversationMessage
import org.thoughtcrime.securesms.ryan.conversation.ConversationOptionsMenu
import org.thoughtcrime.securesms.ryan.conversation.ConversationReactionDelegate
import org.thoughtcrime.securesms.ryan.conversation.ConversationReactionOverlay
import org.thoughtcrime.securesms.ryan.conversation.ConversationReactionOverlay.OnActionSelectedListener
import org.thoughtcrime.securesms.ryan.conversation.ConversationReactionOverlay.OnHideListener
import org.thoughtcrime.securesms.ryan.conversation.ConversationSearchViewModel
import org.thoughtcrime.securesms.ryan.conversation.ConversationUpdateTick
import org.thoughtcrime.securesms.ryan.conversation.MarkReadHelper
import org.thoughtcrime.securesms.ryan.conversation.MenuState
import org.thoughtcrime.securesms.ryan.conversation.MessageSendType
import org.thoughtcrime.securesms.ryan.conversation.MessageStyler.getStyling
import org.thoughtcrime.securesms.ryan.conversation.ReenableScheduledMessagesDialogFragment
import org.thoughtcrime.securesms.ryan.conversation.ScheduleMessageContextMenu
import org.thoughtcrime.securesms.ryan.conversation.ScheduleMessageDialogCallback
import org.thoughtcrime.securesms.ryan.conversation.ScheduleMessageTimePickerBottomSheet
import org.thoughtcrime.securesms.ryan.conversation.ScheduleMessageTimePickerBottomSheet.Companion.showSchedule
import org.thoughtcrime.securesms.ryan.conversation.ScheduledMessagesBottomSheet
import org.thoughtcrime.securesms.ryan.conversation.ScheduledMessagesRepository
import org.thoughtcrime.securesms.ryan.conversation.SelectedConversationModel
import org.thoughtcrime.securesms.ryan.conversation.ShowAdminsBottomSheetDialog
...
import org.thoughtcrime.securesms.ryan.conversation.drafts.DraftRepository
import org.thoughtcrime.securesms.ryan.conversation.drafts.DraftRepository.ShareOrDraftData
import org.thoughtcrime.securesms.ryan.conversation.drafts.DraftViewModel
import org.thoughtcrime.securesms.ryan.conversation.mutiselect.ConversationItemAnimator
import org.thoughtcrime.securesms.ryan.conversation.mutiselect.MultiselectItemDecoration
import org.thoughtcrime.securesms.ryan.conversation.mutiselect.MultiselectPart
import org.thoughtcrime.securesms.ryan.conversation.mutiselect.forward.MultiselectForwardBottomSheet
...
import org.thoughtcrime.securesms.ryan.conversation.quotes.MessageQuotesBottomSheet
import org.thoughtcrime.securesms.ryan.conversation.ui.edit.EditMessageHistoryDialog
import org.thoughtcrime.securesms.ryan.conversation.ui.error.EnableCallNotificationSettingsDialog
...
import org.thoughtcrime.securesms.ryan.conversation.ui.inlinequery.InlineQueryResultsControllerV2
import org.thoughtcrime.securesms.ryan.conversation.ui.inlinequery.InlineQueryViewModelV2
import org.thoughtcrime.securesms.ryan.conversation.v2.computed.ConversationMessageComputeWorkers
...
import org.thoughtcrime.securesms.ryan.conversation.v2.groups.ConversationGroupCallViewModel
import org.thoughtcrime.securesms.ryan.conversation.v2.groups.ConversationGroupViewModel
...
import org.thoughtcrime.securesms.ryan.conversation.v2.keyboard.AttachmentKeyboardFragment
...
import org.thoughtcrime.securesms.ryan.databinding.V2ConversationFragmentBinding
import org.thoughtcrime.securesms.ryan.dependencies.AppDependencies
import org.thoughtcrime.securesms.ryan.events.GroupCallPeekEvent
import org.thoughtcrime.securesms.ryan.giph.mp4.GiphyMp4ItemDecoration
import org.thoughtcrime.securesms.ryan.giph.mp4.GiphyMp4PlaybackController
import org.thoughtcrime.securesms.ryan.giph.mp4.GiphyMp4PlaybackPolicy
import org.thoughtcrime.securesms.ryan.giph.mp4.GiphyMp4ProjectionPlayerHolder
import org.thoughtcrime.securesms.ryan.giph.mp4.GiphyMp4ProjectionRecycler
...
import org.thoughtcrime.securesms.ryan.groups.ui.LeaveGroupDialog
import org.thoughtcrime.securesms.ryan.groups.ui.invitesandrequests.ManagePendingAndRequestingMembersActivity
import org.thoughtcrime.securesms.ryan.groups.ui.invitesandrequests.invite.GroupLinkInviteFriendsBottomSheetDialogFragment
import org.thoughtcrime.securesms.ryan.groups.ui.managegroup.dialogs.GroupDescriptionDialog
import org.thoughtcrime.securesms.ryan.groups.ui.migration.GroupsV1MigrationInfoBottomSheetDialogFragment
import org.thoughtcrime.securesms.ryan.groups.ui.migration.GroupsV1MigrationSuggestionsDialog
...
import org.thoughtcrime.securesms.ryan.jobs.ServiceOutageDetectionJob
import org.thoughtcrime.securesms.ryan.keyboard.KeyboardPage
import org.thoughtcrime.securesms.ryan.keyboard.KeyboardPagerFragment
...
import org.thoughtcrime.securesms.ryan.keyboard.gif.GifKeyboardPageFragment
...
import org.thoughtcrime.securesms.ryan.linkpreview.LinkPreviewViewModelV2
import org.thoughtcrime.securesms.ryan.longmessage.LongMessageFragment
...
import org.thoughtcrime.securesms.ryan.messagedetails.MessageDetailsFragment
import org.thoughtcrime.securesms.ryan.messagerequests.MessageRequestRepository
import org.thoughtcrime.securesms.ryan.mms.AttachmentManager
...
import org.thoughtcrime.securesms.ryan.payments.preferences.PaymentsActivity
...
import org.thoughtcrime.securesms.ryan.profiles.spoofing.ReviewCardDialogFragment
import org.thoughtcrime.securesms.ryan.providers.BlobProvider
import org.thoughtcrime.securesms.ryan.ratelimit.RecaptchaProofBottomSheetFragment
import org.thoughtcrime.securesms.ryan.ratelimit.RecaptchaRequiredEvent
import org.thoughtcrime.securesms.ryan.reactions.ReactionsBottomSheetDialogFragment
...
import org.thoughtcrime.securesms.ryan.recipients.ui.disappearingmessages.RecipientDisappearingMessagesActivity
import org.thoughtcrime.securesms.ryan.registration.ui.RegistrationActivity
import org.thoughtcrime.securesms.ryan.revealable.ViewOnceMessageActivity
import org.thoughtcrime.securesms.ryan.revealable.ViewOnceUtil
...
import org.thoughtcrime.securesms.ryan.stickers.StickerPackPreviewActivity
...
import org.thoughtcrime.securesms.ryan.util.DoubleClickDebouncer
...
import org.thoughtcrime.securesms.ryan.util.MessageConstraintsUtil.getEditMessageThresholdHours
import org.thoughtcrime.securesms.ryan.util.MessageConstraintsUtil.isValidEditMessageSend
...
import org.thoughtcrime.securesms.ryan.util.getQuote
import org.thoughtcrime.securesms.ryan.util.getRecordQuoteType
import org.thoughtcrime.securesms.ryan.util.hasAudio
import org.thoughtcrime.securesms.ryan.util.hasGiftBadge
import org.thoughtcrime.securesms.ryan.util.hasNonTextSlide
import org.thoughtcrime.securesms.ryan.util.isValidReactionTarget
import org.thoughtcrime.securesms.ryan.util.padding
import org.thoughtcrime.securesms.ryan.util.savedStateViewModel
...
import org.thoughtcrime.securesms.ryan.verify.VerifyIdentityActivity
import org.thoughtcrime.securesms.ryan.wallpaper.ChatWallpaper
import org.thoughtcrime.securesms.ryan.wallpaper.ChatWallpaperDimLevelUtil
import org.thoughtcrime.securesms.ryan.window.WindowSizeClass.Companion.getWindowSizeClass
=======
