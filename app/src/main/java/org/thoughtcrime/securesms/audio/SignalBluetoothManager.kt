...
import org.thoughtcrime.securesms.ryan.webrtc.audio.SignalAudioHandler
 ...
 * reports that to the [org.thoughtcrime.securesms.ryan.webrtc.audio.SignalAudioManager], and then handles connecting/disconnecting
 * to the device if requested by [org.thoughtcrime.securesms.ryan.webrtc.audio.SignalAudioManager].
 */
