...
import org.thoughtcrime.securesms.ryan.database.helpers.migration.SignalDatabaseMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V149_LegacyMigrations
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V150_UrgentMslFlagMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V151_MyStoryMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V152_StoryGroupTypesMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V153_MyStoryMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V154_PniSignaturesMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V155_SmsExporterMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V156_RecipientUnregisteredTimestampMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V157_RecipeintHiddenMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V158_GroupsLastForceUpdateTimestampMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V159_ThreadUnreadSelfMentionCount
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V160_SmsMmsExportedIndexMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V161_StorySendMessageIdIndex
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V162_ThreadUnreadSelfMentionCountFixup
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V163_RemoteMegaphoneSnoozeSupportMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V164_ThreadDatabaseReadIndexMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V165_MmsMessageBoxPaymentTransactionIndexMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V166_ThreadAndMessageForeignKeys
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V167_RecreateReactionTriggers
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V168_SingleMessageTableMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V169_EmojiSearchIndexRank
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V170_CallTableMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V171_ThreadForeignKeyFix
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V172_GroupMembershipMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V173_ScheduledMessagesMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V174_ReactionForeignKeyMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V175_FixFullTextSearchLink
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V176_AddScheduledDateToQuoteIndex
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V177_MessageSendLogTableCleanupMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V178_ReportingTokenColumnMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V179_CleanupDanglingMessageSendLogMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V180_RecipientNicknameMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V181_ThreadTableForeignKeyCleanup
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V182_CallTableMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V183_CallLinkTableMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V184_CallLinkReplaceIndexMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V185_MessageRecipientsAndEditMessageMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V186_ForeignKeyIndicesMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V187_MoreForeignKeyIndexesMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V188_FixMessageRecipientsAndEditMessageMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V189_CreateCallLinkTableColumnsAndRebuildFKReference
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V190_UniqueMessageMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V191_UniqueMessageMigrationV2
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V192_CallLinkTableNullableRootKeys
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V193_BackCallLinksWithRecipient
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V194_KyberPreKeyMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V195_GroupMemberForeignKeyMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V196_BackCallLinksWithRecipientV2
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V197_DropAvatarColorFromCallLinks
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V198_AddMacDigestColumn
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V199_AddThreadActiveColumn
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V200_ResetPniColumn
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V201_RecipientTableValidations
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V202_DropMessageTableThreadDateIndex
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V203_PreKeyStaleTimestamp
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V204_GroupForeignKeyMigration
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V205_DropPushTable
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V206_AddConversationCountIndex
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V207_AddChunkSizeColumn
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V209_ClearRecipientPniFromAciColumn
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V210_FixPniPossibleColumns
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V211_ReceiptColumnRenames
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V212_RemoveDistributionListUniqueConstraint
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V213_FixUsernameInE164Column
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V214_PhoneNumberSharingColumn
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V215_RemoveAttachmentUniqueId
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V216_PhoneNumberDiscoverable
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V217_MessageTableExtrasColumn
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V218_RecipientPniSignatureVerified
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V219_PniPreKeyStores
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V220_PreKeyConstraints
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V221_AddReadColumnToCallEventsTable
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V222_DataHashRefactor
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V223_AddNicknameAndNoteFieldsToRecipientTable
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V224_AddAttachmentArchiveColumns
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V225_AddLocalUserJoinedStateAndGroupCallActiveState
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V226_AddAttachmentMediaIdIndex
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V227_AddAttachmentArchiveTransferState
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V228_AddNameCollisionTables
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V229_MarkMissedCallEventsNotified
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V230_UnreadCountIndices
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V231_ArchiveThumbnailColumns
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V232_CreateInAppPaymentTable
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V233_FixInAppPaymentTableDefaultNotifiedValue
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V234_ThumbnailRestoreStateColumn
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V235_AttachmentUuidColumn
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V236_FixInAppSubscriberCurrencyIfAble
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V237_ResetGroupForceUpdateTimestamps
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V238_AddGroupSendEndorsementsColumns
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V239_MessageFullTextSearchEmojiSupport
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V240_MessageFullTextSearchSecureDelete
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V241_ExpireTimerVersion
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V242_MessageFullTextSearchEmojiSupportV2
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V243_MessageFullTextSearchDisableSecureDelete
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V244_AttachmentRemoteIv
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V245_DeletionTimestampOnCallLinks
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V246_DropThumbnailCdnFromAttachments
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V247_ClearUploadTimestamp
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V250_ClearUploadTimestampV2
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V251_ArchiveTransferStateIndex
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V252_AttachmentOffloadRestoredAtColumn
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V253_CreateChatFolderTables
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V254_AddChatFolderConstraint
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V255_AddCallTableLogIndex
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V256_FixIncrementalDigestColumns
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V257_CreateBackupMediaSyncTable
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V258_FixGroupRevokedInviteeUpdate
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V259_AdjustNotificationProfileMidnightEndTimes
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V260_RemapQuoteAuthors
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V261_RemapCallRingers
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V263_InAppPaymentsSubscriberTableRebuild
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V264_FixGroupAddMemberUpdate
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V265_FixFtsTriggers
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V266_UniqueThreadPinOrder
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V267_FixGroupInvitationDeclinedUpdate
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V268_FixInAppPaymentsErrorStateConsistency
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V269_BackupMediaSnapshotChanges
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V270_FixChatFolderColumnsForStorageSync
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V271_AddNotificationProfileIdColumn
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V272_UpdateUnreadCountIndices
import org.thoughtcrime.securesms.ryan.database.helpers.migration.V273_FixUnreadOriginalMessages
